...
| 챕터 | 주제 | 실행 방법 |
|------|------|---------|
| [chapter100](../chapters/chapter100/practice.py) | SVM 실습 | `cd chapters/chapter100 && python practice.py` |

---

➡️ [Day 032 — 스무고개 주식 예측: 결정 트리](18.md) 에서 계속됩니다.
