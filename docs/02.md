...
> 🌟 **초등생도 알 수 있어요!**  
> 운동장에서 남학생 팀과 여학생 팀이 나뉘어 서 있다고 상상해봐요.  
> 두 팀 사이에 금을 그을 건데, 어느 쪽 친구도 금에 너무 가까이 붙지 않도록 **가장 넓은 통로**를 남기는 선이 가장 좋아요.  
> SVM은 바로 그 선을 찾아주는 방법이에요! 선 바로 가까이 서 있는 친구들이 **서포트 벡터**, 즉 선의 위치를 결정하는 핵심이에요. 🏃
