# Day 035 — 컴퓨터 뇌 만들기: 신경망(MLP)

> 초등학생의 질문: "사람처럼 생각하는 컴퓨터를 만들 수 있나요?"
...
| 챕터 | 주제 | 실행 방법 |
|------|------|---------|
| [chapter21](../chapters/chapter21/practice.py) | 신경망 기초 | `cd chapters/chapter21 && python practice.py` |
| [chapter27](../chapters/chapter27/practice.py) | 경사하강법 실험 | `cd chapters/chapter27 && python practice.py` |
