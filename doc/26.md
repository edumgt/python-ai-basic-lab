# Day 040 — 내 예측, 얼마나 정확한가? 모델 평가

> 초등학생의 질문: "내가 만든 예측 모델이 정말 좋은 건지 어떻게 알 수 있나요?"
...
| 챕터 | 주제 | 실행 방법 |
|------|------|---------|
| [chapter10](../chapters/chapter10/practice.py) | 모델 평가 지표 | `cd chapters/chapter10 && python practice.py` |
| [chapter107](../chapters/chapter107/practice.py) | 백테스트 성과 | `cd chapters/chapter107 && python practice.py` |
| [chapter112](../chapters/chapter112/practice.py) | 주가 예측 프로젝트 | `cd chapters/chapter112 && python practice.py` |

---

**모듈 6 완료! 초등학생도 주식 예측 AI를 만들 수 있습니다!**
